...
/**
 * JUnit test to make sure that the methods
 * {@link Verify#assertListsEqual(String, List, List)},
 * {@link Verify#assertSetsEqual(String, Set, Set)},
 * and {@link Verify#assertMapsEqual(String, Map, Map)} really throw when they
 * ought to.
 */
...
public class CollectionsEqualTest {
    ...
    public void mapsDifferentValue() {
        try {
            ...
            Verify.assertContains(CollectionsEqualTest.class.getName(), e.getStackTrace()[2].toString());
        }
